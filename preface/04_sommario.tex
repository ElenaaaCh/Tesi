...
Il prodotto finale dello stage è un'estensione web \glslink{Chrome-basedg}{Chrome-based} per aiutare gli sviluppatori web nella creazione di pagine web accessibili.\\
\\
...
\begin{itemize}
    ...
    \item Creazione di un'estensione web che integri un \glslink{chatbotg}{chatbot} \acrshort{ai} per analizzare il codice sorgente della pagina web ed offrire risposte adeguate.
\end{itemize}
