...
% Nuove entries glossario / acronimi:
% - IA / AI (acronimo e definizione)
% - WCAG (solo acronimo, definizione nell'introduzione)
% - LLM (acronimo e definizione)
% - W3C (acronimo e definizione)
% - XML (acronimo e definizione)
% - URL (acronimo e definizione)
% - GPU (acronimo e definizione)
% - chatbot (definizione)
% - plugin (definizione)
% - markup (definizione)
% - form (definizione)
