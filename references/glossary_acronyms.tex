...
\newacronym[description={\glslink{llmg}{\textit{Large Language Model\glox}}}]
    {llm}{LLM}{\textit{Large Language Model}}
\newacronym[description={\glslink{w3cg}{\textit{World Wide Web Consortium\glox}}}]
    {w3c}{W3C}{\textit{World Wide Web Consortium}}
\newacronym[description={\glslink{xmlg}{\textit{Extensible Markup Language\glox}}}]
    {xml}{XML}{\textit{Extensible Markup Language}}
\newacronym[description={\glslink{urlg}{\textit{Uniform Resource Locator\glox}}}]
    {url}{URL}{\textit{Uniform Resource Locator}}
\newacronym[description={\glslink{gpug}{\textit{Graphics Processing Unit\glox}}}]
...
\newacronym{tcp}{TCP}{\glslink{tcpg}{\textit{Transmission Control Protocol\glox}}}
...
\newglossaryentry{w3cg}{
    ...
    sort=w3c,
    description= {il \textit{World Wide Web Consortium}, anche conosciuto come \acrshort{w3c}, è un'organizzazione non governativa internazionale che ha come scopo quello di favorire lo sviluppo di tutte le potenzialità del \glslink{wwwg}{World Wide Web\glox} e diffondere la cultura dell'accessibilità della Rete.\\
    \cite{site:w3c-wiki}
    }
}
...
\newglossaryentry{websocketg} {
    ...
    text=WebSocket,
    sort=websocket,
    description={ è un protocollo che fornisce canali di comunicazione full-duplex (trasmissione bidirezionale simultanea) attraverso una singola connessione \glslink{tcp}{\acrshort{tcp}\glox}. \\
