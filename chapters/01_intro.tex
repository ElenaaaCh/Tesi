...
\noindent Sul mercato esistono diversi strumenti e \glslink{pluging}{plugin} dedicati alla verifica dell’accessibilità delle pagine web, come WAVE [\ref{subsec:wave}], Total Validator [\ref{subsec:tv}] e Lighthouse [\ref{subsec:lighthouse}], che offrono principalmente funzionalità di scansione automatica e generazione di report.\\ 
