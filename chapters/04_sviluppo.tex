...
\begin{lstlisting}[language=JavaScript, caption={Funzione di interazione con Ollama}, label={lst:funzOllama}]
...
\begin{itemize}
    ...
    \begin{lstlisting}[language=JavaScript, caption={Prompt per la generazione di risposta e righe da evidenziare}, label={lst:rr}]
    ...
    \begin{lstlisting}[language=JavaScript, caption={Prompt per la generazione di domande successive}, label={lst:dsucc}]
    ...
    \begin{lstlisting}[language=JavaScript, caption={Prompt per la generazione di risposta e codice \acrshort{html} accessibile}, label={lst:rc}]
    const promptCodice =
