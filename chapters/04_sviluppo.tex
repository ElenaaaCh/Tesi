...
\begin{itemize}
  ...
  \item \texttt{service\_worker.js}: gestisce le richieste verso il modello di intelligenza artificiale, inviando il codice recuperato e ricevendo in risposta i suggerimenti generati.
\end{itemize}
