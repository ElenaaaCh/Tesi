...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth, alt={Pagina \acrshort{html} basica per effettuare i test della modalità guidata}]{img/test_MG.png}
    \caption{Pagina \acrshort{html} basica per effettuare i test della modalità guidata}\label{fig:pagina_test}
\end{figure}
